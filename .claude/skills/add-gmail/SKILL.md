...
> - Triggered only from WhatsApp (e.g., "@Blanc check my email" or "@Blanc send an email to...")
...
>
> `@Blanc check my recent emails`
>
> Or:
>
> `@Blanc list my Gmail labels`
...
> - Emails to a specific address pattern (e.g., Blanc+task@gmail.com)
> - Uses Gmail's plus-addressing feature
>
> **Option C: Subject Prefix**
> - Emails with a subject starting with a keyword (e.g., "[Blanc]")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@Blanc check my recent emails`.
